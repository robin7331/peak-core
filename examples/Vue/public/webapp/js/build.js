...
},{"../package.json":24,"./required-js-methods":2,"./required-native-methods":3}],2:[function(require,module,exports){
module.exports = {
	'peakCore' : [
		{
			name: 'enableDebug',	
...
},{"./package.json":4}],6:[function(require,module,exports){
...
},{"../../../index":17,"../../../modules/peak-actions":23,"../../PeakModule":5,"./components/list.vue":15,"./config/method-definitions":16,"jQuery":7,"vue":11,"vue-touch":10}],14:[function(require,module,exports){
...
module.exports = {
	...
	data: function data() {
		return {
			items: [{ name: "Hello 1" }, { name: "Hello 2" }, { name: "Hello 3" }, { name: "Hello 4" }]
		};
	},
...
var logger = function Logger(core, privateHelpers) {
   ...
   this.infoMethodDefinition = privateHelpers.getNativeMethodDefinition('peakCore', 'log');
   this.errorMethodDefinition = privateHelpers.getNativeMethodDefinition('peakCore', 'logError');
}
...
Core.prototype.callJS = function(namespace, functionName, payload, nativeCallback) {
	...
	var JSMethodDefinition = privateHelpers.getJSMethodDefinition(namespace, functionName);
...
Core.prototype.callCallback = function(callbackFunctionName, jsonData) {
	...
	if (callbackFunctionName in nativeCallbackFunctions) {
		...
		var method = privateHelpers.getNativeMethodDefinition(callerNamespace, callerFunctionName);
...
Core.prototype.callNative = function(namespace, functionName, payload, callback) {
	...
	var nativeMethodDefinition = privateHelpers.getNativeMethodDefinition(namespace, functionName);
...
Actions.prototype.openURL = function(url) {
   this._callNative('openURL', url);
}
...
},{"./package.json":22}],24:[function(require,module,exports){
module.exports={
  ...
  "scripts": {
    "test": "echo \"Error: no test specified\" && exit 1",
    "example": "node ./examples/normal-usage.js"
  },
  "repository": {
    "type": "git",
