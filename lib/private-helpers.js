 ...
 */
Helpers.prototype.execNativeCall = function(namespace, nativeMethodDefinition, payload, callbackKey) {
	if (this.core.helpers.isiOS()) {
      ...
      if (typeof(window) == 'undefined' || typeof(window.webkit) == 'undefined' || typeof(window.webkit.messageHandlers) == 'undefined') {
		...
		try{
			...
			console.error(nativeMethodDefinition.name + "(). Android Interface method not defined.")
		}
	}
};
