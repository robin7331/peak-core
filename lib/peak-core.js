 ...
 */
Core.prototype.installPeakModule = function(ModuleClass, customData) {
	...
	if (typeof(packageJSON.skipJSMethodValidationOnInstall) == 'undefined') {
		packageJSON.skipJSMethodValidationOnInstall = false;
	}
	...
	for (var i = 0; i < module.JSMethods.length; i++) {
		...
		if (packageJSON.skipJSMethodValidationOnInstall == false) {
